...
// En tu ruta de renderización de la página
app.get('/productos', async (req, res) => {
    try {
        // Recuperar las categorías de la base de datos
        const categorias = await Categoria.find();

        // Renderizar la página y pasar las categorías al template
...
// En tu ruta de renderización de la página de productos
app.get('/productos', async (req, res) => {
    try {
        // Recuperar los productos de la base de datos
        const productos = await Producto.find();

        // Renderizar la página y pasar los productos al template
